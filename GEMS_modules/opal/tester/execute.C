 ...
 * Synopsis:  tests the execution accuracy of the decoder / execution engine
 * Author:    cmauer
 * Version:   $Id: execute.C 1.7 06/02/13 18:49:24-06:00 mikem@maya.cs.wisc.edu $
 */
...
int main( int argc, char *argv[] ) {
  ...
  // read the trace, executing all of the instructions, checking the results
  system_t::inst->testExecute();
