...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFSPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFSPQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:59:52 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFSPQL(D, SB, CK, SD, SE, Q);
input D;
input SB;
input CK;
input SD;
