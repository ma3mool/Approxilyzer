...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERSPB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERSPB1.v,v $ 
...
/*  Created:  Thu Feb 20 16:13:39 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERSPB1(CEB, D, RB, SB, CK, Q, QB);
input CEB;
input D;
input RB;
input SB;
