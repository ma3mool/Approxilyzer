...
// 
// File Name:       HDADFULD2.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:26:33
// ------------------------------------------------------------------------
//  
// $RCSfile: HDADFULD2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDADFULD2.v,v $ 
...
/*  Created:  Thu Feb 20 16:54:04 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDADFULD2(CO, S, A, B, CI);
input A;
input B;
input CI;
output CO;
output S;
 HDADFULD2_UDPCO(CO, A, B, CI);
 HDADFULD2_UDPS(S, A, B, CI);
specify
// arc A --> CO
...
primitive HDADFULD2_UDPCO(CO, A, B, CI);
output CO;
input A;
input B;
input CI;
...
primitive HDADFULD2_UDPS(S, A, B, CI);
output S;
input A;
input B;
input CI;
