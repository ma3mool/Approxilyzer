...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFPBL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFPBL.v,v $ 
...
/*  Created:  Thu Feb 20 16:56:34 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFPBL(D, CK, SD, SE, Q, QB);
input D;
input CK;
input SD;
input SE;
