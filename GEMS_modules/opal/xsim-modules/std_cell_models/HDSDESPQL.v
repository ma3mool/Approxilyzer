...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDESPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDESPQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:06:39 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDESPQL(CEB, D, SB, CK, SD, SE, Q);
input CEB;
input D;
input SB;
input CK;
