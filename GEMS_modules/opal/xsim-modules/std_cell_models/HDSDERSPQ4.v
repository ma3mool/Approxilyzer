...
// 
// File Name:       HDSDERSPQ4.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:30:01
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERSPQ4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERSPQ4.v,v $ 
// $Date: 2003/04/23 22:40:33 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 15:58:45 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERSPQ4(CEB, D, RB, SB, CK, SD, SE, Q);
input CEB;
input D;
input RB;
input SB;
...
and SMC_I9(shcheckCKCEBlh, RB, SB, SE_bar);
not SMC_I10(CEB_bar, CEB);
and SMC_I11(shcheckCKDlh, CEB_bar, RB, SB, SE_bar);
buf SMC_I12(shcheckCKRBlh, SB);
buf SMC_I13(shcheckCKSBlh, `VCC);
and SMC_I14(shcheckCKSDlh, RB, SB, SE);
and SMC_I15(shcheckCKSElh, RB, SB);
`endif
specify
// arc RB --> Q
  ( RB => Q ) = (1,1);
