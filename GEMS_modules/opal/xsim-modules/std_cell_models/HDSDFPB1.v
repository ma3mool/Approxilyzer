...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFPB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFPB1.v,v $ 
...
/*  Created:  Thu Feb 20 16:47:27 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFPB1(D, CK, SD, SE, Q, QB);
input D;
input CK;
input SD;
input SE;
