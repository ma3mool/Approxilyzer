...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERSPB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERSPB4.v,v $ 
...
/*  Created:  Thu Feb 20 16:16:15 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERSPB4(CEB, D, RB, SB, CK, Q, QB);
input CEB;
input D;
input RB;
input SB;
