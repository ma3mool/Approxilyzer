...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERPB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERPB1.v,v $ 
...
/*  Created:  Thu Feb 20 16:50:43 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERPB1(CEB, D, RB, CK, SD, SE, Q, QB);
input CEB;
input D;
input RB;
input CK;
