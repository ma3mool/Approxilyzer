...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDEXNOR3D2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDEXNOR3D2.v,v $ 
...
/*  Created:  Thu Feb 20 17:00:01 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDEXNOR3D2(Z, A1, A2, A3);
input A1;
input A2;
input A3;
output Z;
 HDEXNOR3D2_UDPZ(Z, A1, A2, A3);
specify
// arc A1 --> Z
...
// arc A3 --> Z
  ...
  ifnone ( A3 => Z ) = (1,1);
endspecify
endmodule // HDEXNOR3D2 //

primitive HDEXNOR3D2_UDPZ(Z, A1, A2, A3);
output Z;
input A1;
input A2;
input A3;
