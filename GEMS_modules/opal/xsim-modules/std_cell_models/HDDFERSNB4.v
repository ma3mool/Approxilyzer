...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERSNB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERSNB4.v,v $ 
...
/*  Created:  Thu Feb 20 16:47:53 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERSNB4(CEB, D, RB, SB, CKB, Q, QB);
input CEB;
input D;
input RB;
input SB;
