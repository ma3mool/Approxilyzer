...
// 
// File Name:       HDDFFRPB2.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:27:51
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRPB2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRPB2.v,v $ 
// $Date: 2003/04/23 22:38:56 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:33:42 2003 by sasana                             */
...
dff_p0 SMC_I1(.q(SMC_IQ), .d(D), .clk(CK), .clear(RB), .preset(`VCC), .notifier(notifier));
//  output pins
buf SMC_I2(Q, SMC_IQ);
...
`else
  ...
  $recovery( posedge RB,  posedge CK, 1, notifier);
  $hold( posedge CK,  posedge RB, 1, notifier);
