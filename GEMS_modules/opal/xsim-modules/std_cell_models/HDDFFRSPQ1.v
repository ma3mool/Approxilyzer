...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRSPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRSPQ1.v,v $ 
...
/*  Created:  Thu Feb 20 16:29:04 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRSPQ1(D, RB, SB, CK, Q);
input D;
input RB;
input SB;
input CK;
