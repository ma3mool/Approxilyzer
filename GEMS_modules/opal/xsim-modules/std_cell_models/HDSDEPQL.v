...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDEPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDEPQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:26:46 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDEPQL(CEB, D, CK, SD, SE, Q);
input CEB;
input D;
input CK;
input SD;
