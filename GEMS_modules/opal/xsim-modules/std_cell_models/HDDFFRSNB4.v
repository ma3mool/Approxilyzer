...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRSNB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRSNB4.v,v $ 
...
/*  Created:  Thu Feb 20 16:17:59 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRSNB4(D, RB, SB, CKB, Q, QB);
input D;
input RB;
input SB;
input CKB;
