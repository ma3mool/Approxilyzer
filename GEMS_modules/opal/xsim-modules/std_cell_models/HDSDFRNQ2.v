...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRNQ2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRNQ2.v,v $ 
...
/*  Created:  Thu Feb 20 16:08:18 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRNQ2(D, RB, CKB, SD, SE, Q);
input D;
input RB;
input CKB;
input SD;
