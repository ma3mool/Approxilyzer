...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRSNB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRSNB4.v,v $ 
...
/*  Created:  Thu Feb 20 16:33:34 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRSNB4(D, RB, SB, CKB, SD, SE, Q, QB);
input D;
input RB;
input SB;
input CKB;
