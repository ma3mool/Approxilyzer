...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERSPB2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERSPB2.v,v $ 
...
/*  Created:  Thu Feb 20 16:31:31 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERSPB2(CEB, D, RB, SB, CK, SD, SE, Q,
QB);
input CEB;
input D;
input RB;
