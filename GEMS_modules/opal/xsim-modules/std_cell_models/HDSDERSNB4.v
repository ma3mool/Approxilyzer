...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERSNB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERSNB4.v,v $ 
...
/*  Created:  Thu Feb 20 17:05:23 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERSNB4(CEB, D, RB, SB, CKB, SD, SE, Q,
QB);
input CEB;
input D;
input RB;
