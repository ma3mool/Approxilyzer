...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFPB2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFPB2.v,v $ 
...
/*  Created:  Thu Feb 20 16:48:02 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFPB2(D, CK, SD, SE, Q, QB);
input D;
input CK;
input SD;
input SE;
