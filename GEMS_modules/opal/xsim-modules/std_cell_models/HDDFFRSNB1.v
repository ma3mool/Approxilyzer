...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRSNB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRSNB1.v,v $ 
// $Date: 2003/04/23 22:38:59 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:17:41 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRSNB1(D, RB, SB, CKB, Q, QB);
input D;
input RB;
input SB;
input CKB;
