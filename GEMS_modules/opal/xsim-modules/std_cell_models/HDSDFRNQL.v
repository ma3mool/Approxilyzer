...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRNQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRNQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:18:28 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRNQL(D, RB, CKB, SD, SE, Q);
input D;
input RB;
input CKB;
input SD;
