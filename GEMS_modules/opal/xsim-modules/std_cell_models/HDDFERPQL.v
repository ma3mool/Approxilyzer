...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERPQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:33:54 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERPQL(CEB, D, RB, CK, Q);
input CEB;
input D;
input RB;
input CK;
