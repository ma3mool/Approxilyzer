...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFPB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFPB4.v,v $ 
// $Date: 2003/04/23 22:40:36 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:48:47 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFPB4(D, CK, SD, SE, Q, QB);
input D;
input CK;
input SD;
input SE;
