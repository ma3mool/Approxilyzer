...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRSPQ2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRSPQ2.v,v $ 
...
/*  Created:  Thu Feb 20 16:29:34 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRSPQ2(D, RB, SB, CK, Q);
input D;
input RB;
input SB;
input CK;
