...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFESPQ4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFESPQ4.v,v $ 
...
/*  Created:  Thu Feb 20 16:13:47 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFESPQ4(CEB, D, SB, CK, Q);
input CEB;
input D;
input SB;
input CK;
