...
// 
// File Name:       HDDFFRPQ4.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:27:56
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRPQ4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRPQ4.v,v $ 
// $Date: 2003/04/23 22:38:58 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:02:15 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRPQ4(D, RB, CK, Q);
input D;
input RB;
input CK;
output Q;
reg notifier;
dff_p0 SMC_I0(.q(SMC_IQ), .d(D), .clk(CK), .clear(RB), .preset(`VCC), .notifier(notifier));
//  output pins
buf SMC_I1(Q, SMC_IQ);
`ifdef no_tchk
`else
