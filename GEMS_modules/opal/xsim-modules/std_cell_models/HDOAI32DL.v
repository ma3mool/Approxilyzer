...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDOAI32DL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDOAI32DL.v,v $ 
...
/*  Created:  Thu Feb 20 17:05:56 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDOAI32DL(A1, A2, A3, B1, B2, Z);
input A1;
input A2;
input A3;
input B1;
