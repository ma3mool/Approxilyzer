...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERPB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERPB4.v,v $ 
...
/*  Created:  Thu Feb 20 17:09:24 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERPB4(CEB, D, RB, CK, Q, QB);
input CEB;
input D;
input RB;
input CK;
