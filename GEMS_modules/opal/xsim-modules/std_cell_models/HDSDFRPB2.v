...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRPB2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRPB2.v,v $ 
...
/*  Created:  Thu Feb 20 16:18:46 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRPB2(D, RB, CK, SD, SE, Q, QB);
input D;
input RB;
input CK;
input SD;
