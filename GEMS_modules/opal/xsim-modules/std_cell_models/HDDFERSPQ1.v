...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERSPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERSPQ1.v,v $ 
...
/*  Created:  Thu Feb 20 17:00:17 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERSPQ1(CEB, D, RB, SB, CK, Q);
input CEB;
input D;
input RB;
input SB;
