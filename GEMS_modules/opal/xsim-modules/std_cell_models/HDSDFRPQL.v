...
// 
// File Name:       HDSDFRPQL.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:30:12
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRPQL.v,v $ 
// $Date: 2003/04/23 22:40:41 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 15:53:12 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRPQL(D, RB, CK, SD, SE, Q);
input D;
input RB;
input CK;
input SD;
...
dff_p0 SMC_I5(.q(SMC_IQ), .d(SMC_NS_IN), .clk(CK), .clear(RB), .preset(`VCC), .notifier(notifier));
//  output pins
buf SMC_I6(Q, SMC_IQ);
`ifdef no_tchk
`else
...
buf SMC_I9(shcheckCKRBlh, `VCC);
and SMC_I10(shcheckCKSDlh, RB, SE);
buf SMC_I11(shcheckCKSElh, RB);
`endif
specify
// arc RB --> Q
  ( RB => Q ) = (1,1);
