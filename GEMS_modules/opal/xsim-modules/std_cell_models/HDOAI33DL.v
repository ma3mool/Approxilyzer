...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDOAI33DL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDOAI33DL.v,v $ 
...
/*  Created:  Wed Dec 04 13:51:12 2002 by dharman                            */
...
`suppress_faults
`enable_portfaults
module HDOAI33DL(A1, A2, A3, B1, B2, B3, Z);
input A1;
input A2;
input A3;
input B1;
