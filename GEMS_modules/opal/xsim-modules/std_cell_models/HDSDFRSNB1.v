...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRSNB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRSNB1.v,v $ 
...
/*  Created:  Thu Feb 20 16:32:28 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRSNB1(D, RB, SB, CKB, SD, SE, Q, QB);
input D;
input RB;
input SB;
input CKB;
