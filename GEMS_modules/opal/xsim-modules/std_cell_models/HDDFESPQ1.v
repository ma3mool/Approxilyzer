...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFESPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFESPQ1.v,v $ 
...
/*  Created:  Thu Feb 20 16:12:43 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFESPQ1(CEB, D, SB, CK, Q);
input CEB;
input D;
input SB;
input CK;
