...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERPQ1.v,v $ 
...
/*  Created:  Thu Feb 20 16:25:30 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERPQ1(CEB, D, RB, CK, Q);
input CEB;
input D;
input RB;
input CK;
