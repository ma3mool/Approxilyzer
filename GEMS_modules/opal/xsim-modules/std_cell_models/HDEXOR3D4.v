...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDEXOR3D4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDEXOR3D4.v,v $ 
...
/*  Created:  Thu Feb 20 17:09:41 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDEXOR3D4(Z, A1, A2, A3);
input A1;
input A2;
input A3;
output Z;
 HDEXOR3D4_UDPZ(Z, A1, A2, A3);
specify
// arc A1 --> Z
...
primitive HDEXOR3D4_UDPZ(Z, A1, A2, A3);
output Z;
input A1;
input A2;
input A3;
