...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERPQL.v,v $ 
...
/*  Created:  Thu Feb 20 16:18:55 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERPQL(CEB, D, RB, CK, SD, SE, Q);
input CEB;
input D;
input RB;
input CK;
