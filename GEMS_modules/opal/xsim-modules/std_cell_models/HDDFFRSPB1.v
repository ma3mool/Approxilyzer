...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFFRSPB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFFRSPB1.v,v $ 
...
/*  Created:  Thu Feb 20 15:51:57 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFFRSPB1(D, RB, SB, CK, Q, QB);
input D;
input RB;
input SB;
input CK;
