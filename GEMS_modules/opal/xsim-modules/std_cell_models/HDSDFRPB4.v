...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFRPB4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFRPB4.v,v $ 
...
/*  Created:  Thu Feb 20 16:19:28 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFRPB4(D, RB, CK, SD, SE, Q, QB);
input D;
input RB;
input CK;
input SD;
