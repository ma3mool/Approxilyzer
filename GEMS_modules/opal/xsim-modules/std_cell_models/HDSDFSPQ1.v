...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDFSPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDFSPQ1.v,v $ 
...
/*  Created:  Thu Feb 20 16:51:10 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDFSPQ1(D, SB, CK, SD, SE, Q);
input D;
input SB;
input CK;
input SD;
