...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDADFULD4.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDADFULD4.v,v $ 
...
/*  Created:  Thu Feb 20 16:54:32 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDADFULD4(CO, S, A, B, CI);
input A;
input B;
input CI;
output CO;
output S;
 HDADFULD4_UDPCO(CO, A, B, CI);
 HDADFULD4_UDPS(S, A, B, CI);
specify
// arc A --> CO
...
primitive HDADFULD4_UDPCO(CO, A, B, CI);
output CO;
input A;
input B;
input CI;
...
primitive HDADFULD4_UDPS(S, A, B, CI);
output S;
input A;
input B;
input CI;
