...
// 
// File Name:       HDSDERSNB2.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:30:02
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERSNB2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERSNB2.v,v $ 
// $Date: 2003/04/23 22:40:31 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 17:03:54 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERSNB2(CEB, D, RB, SB, CKB, SD, SE, Q,
QB);
input CEB;
input D;
input RB;
...
mux21 SMC_I4(SMC_D_EQN, SMC_IQ, D, CEB);
and SMC_I5(SMC_D_DIS, SMC_DIS_SCAN, SMC_D_EQN);
and SMC_I6(SMC_D_SCAN, SMC_EN_SCAN, SD);
or SMC_I7(SMC_NS_IN, SMC_D_DIS, SMC_D_SCAN);
dff_p1 SMC_I8(.q(SMC_IQ), .d(SMC_NS_IN), .clk(SMC_CK_IN), .clear(RB), .preset(SB), .notifier(notifier));
//  output pins
buf SMC_I9(Q, SMC_IQ);
buf SMC_I10(QB, SMC_IQN);
`ifdef no_tchk
`else
not SMC_I11(SE_bar, SE);
and SMC_I12(shcheckCKBCEBhl, RB, SB, SE_bar);
not SMC_I13(CEB_bar, CEB);
and SMC_I14(shcheckCKBDhl, CEB_bar, RB, SB, SE_bar);
buf SMC_I15(shcheckCKBRBhl, SB);
buf SMC_I16(shcheckCKBSBhl, `VCC);
and SMC_I17(shcheckCKBSDhl, RB, SB, SE);
and SMC_I18(shcheckCKBSEhl, RB, SB);
`endif
specify
// arc RB --> Q
  ( RB => Q ) = (1,1);
