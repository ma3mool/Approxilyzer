...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERSPQL.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERSPQL.v,v $ 
...
/*  Created:  Thu Feb 20 17:09:49 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERSPQL(CEB, D, RB, SB, CK, Q);
input CEB;
input D;
input RB;
input SB;
