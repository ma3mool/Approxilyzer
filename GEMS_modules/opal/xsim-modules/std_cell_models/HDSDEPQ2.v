...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDEPQ2.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDEPQ2.v,v $ 
...
/*  Created:  Thu Feb 20 16:20:07 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDEPQ2(CEB, D, CK, SD, SE, Q);
input CEB;
input D;
input CK;
input SD;
