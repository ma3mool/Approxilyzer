...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDSDERPQ1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDSDERPQ1.v,v $ 
// $Date: 2003/04/23 22:40:29 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:08:28 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDSDERPQ1(CEB, D, RB, CK, SD, SE, Q);
input CEB;
input D;
input RB;
input CK;
...
and SMC_I9(shcheckCKCEBlh, RB, SE_bar);
not SMC_I10(CEB_bar, CEB);
and SMC_I11(shcheckCKDlh, CEB_bar, RB, SE_bar);
buf SMC_I12(shcheckCKRBlh, `VCC);
and SMC_I13(shcheckCKSDlh, RB, SE);
buf SMC_I14(shcheckCKSElh, RB);
`endif
specify
// arc RB --> Q
  ( RB => Q ) = (1,1);
