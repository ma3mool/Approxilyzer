...
// 
// File Name:       HDADFULD1.v
// Library Name:    umce13h210t3
// Library Release: 1.2
// Product:         High Density Standard Cells
// Process:         UMC L130E-HS-FSG
// Generated:       07/16/2003 15:26:32
// ------------------------------------------------------------------------
//  
// $RCSfile: HDADFULD1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDADFULD1.v,v $ 
// $Date: 2003/04/23 22:37:55 $ 
// $Revision: 1.2 $ 
//  
// ---------------------- 
...
/*  Created:  Thu Feb 20 16:53:28 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDADFULD1(CO, S, A, B, CI);
input A;
input B;
input CI;
output CO;
output S;
 HDADFULD1_UDPCO(CO, A, B, CI);
 HDADFULD1_UDPS(S, A, B, CI);
specify
// arc A --> CO
...
primitive HDADFULD1_UDPCO(CO, A, B, CI);
output CO;
input A;
input B;
input CI;
...
primitive HDADFULD1_UDPS(S, A, B, CI);
output S;
input A;
input B;
input CI;
