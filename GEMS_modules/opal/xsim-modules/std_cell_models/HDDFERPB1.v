...
// ------------------------------------------------------------------------
//  
// $RCSfile: HDDFERPB1.v,v $ 
// $Source: /syncdisk/rcs/common/verilog/5.1.4.3/sc/RCS/HDDFERPB1.v,v $ 
...
/*  Created:  Thu Feb 20 17:08:10 2003 by sasana                             */
...
`suppress_faults
`enable_portfaults
module HDDFERPB1(CEB, D, RB, CK, Q, QB);
input CEB;
input D;
input RB;
input CK;
