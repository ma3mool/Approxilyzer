...
INPUT_DIR=$APPROXILYZER/fault_list_output/coverage_calculation/raw_outcomes_feigned
OUTPUT_DIR=$APPROXILYZER/fault_list_output/coverage_calculation/reformatted_outcomes
